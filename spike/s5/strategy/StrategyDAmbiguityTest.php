<?php
/**
 * Spike S5 — Strategy D ambiguity tests: exact source_hash rematch must never guess.
 *
...
final class StrategyDAmbiguityTest extends \WP_UnitTestCase {

	private static array $all_results = array();

	public static function tearDownAfterClass(): void {
		file_put_contents(
			__DIR__ . '/../corpus/strategy-d-ambiguity.json',
	...
	private function sync( array $before_segments, array $after_segments ): array {
		...
		return StrategyDReconciler::sync_source( $rows, $after_segments );
	}
	...
	public function test_duplicate_paragraphs_reorder_uses_direct_key_not_rematch(): void {
		...
		$after = StrategyD::extract( $tree->to_content() );
