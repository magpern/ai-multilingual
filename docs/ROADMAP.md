...
**Active post-v1.5.1 milestone:** **P0 Localized URL Operator Completion** — [plan](plans/LOCALIZED_URL_OPERATOR_COMPLETION_P0_IMPLEMENTATION_PLAN.md) (**FROZEN**; implementation not yet complete). Version remains **1.5.1** — milestone closure ≠ release closure. **P1** G4 characterization and **P2** Jobs/stale literacy **NOT STARTED**. Historical Program B **REDEFINED** into P0.
