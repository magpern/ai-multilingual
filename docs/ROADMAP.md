...
| **Post-v1 product roadmap** | **Active** — [POST_V1_PRODUCT_ROADMAP.md](plans/POST_V1_PRODUCT_ROADMAP.md); next initiative **Background Translation Jobs** |
...
| **Background Translation Jobs** | **J0–J8 complete** on `feature/background-translation-jobs` — [plan](plans/BACKGROUND_TRANSLATION_JOBS_IMPLEMENTATION_PLAN.md); [validation log](plans/BACKGROUND_TRANSLATION_JOBS_VALIDATION_LOG.md); [ADR-0011](adr/0011-resumable-job-pipeline.md) **Accepted**; merge/tag pending after deploy smoke |
