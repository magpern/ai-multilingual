...
| **Background Translation Jobs** | **Planning** — [canonical plan](plans/BACKGROUND_TRANSLATION_JOBS_IMPLEMENTATION_PLAN.md); [ADR-0011](adr/0011-resumable-job-pipeline.md) amendment **Proposed** (Gate A/B before J1); branch `feature/background-translation-jobs-plan`; no implementation started |
