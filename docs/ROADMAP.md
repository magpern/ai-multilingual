...
| **Post-v1 product roadmap** | **Active** — [POST_V1_PRODUCT_ROADMAP.md](plans/POST_V1_PRODUCT_ROADMAP.md); next initiative **Review Workflow** (R0–R7 complete, pending merge) |
...
| **Review Workflow** | **R0–R7 complete, validation PASS** on `feature/review-workflow`; not yet merged to `main` — [REVIEW_WORKFLOW_IMPLEMENTATION_PLAN.md](plans/REVIEW_WORKFLOW_IMPLEMENTATION_PLAN.md); [validation log PASS](plans/REVIEW_WORKFLOW_VALIDATION_LOG.md); ADR-0015 **Accepted** ([0015-review-workflow-and-tm-approval-policy.md](adr/0015-review-workflow-and-tm-approval-policy.md)); review queue = Store filter view (not assignments); manual browser smoke pending deploy |
