...
| **Background Translation Jobs** | **Implementing** — [canonical plan](plans/BACKGROUND_TRANSLATION_JOBS_IMPLEMENTATION_PLAN.md); [ADR-0011](adr/0011-resumable-job-pipeline.md) amendment **Accepted** (Gate A, 2026-08-06); branch `feature/background-translation-jobs` |
