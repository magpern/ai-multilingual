...
| **Post-v1 product roadmap** | **Planning** — [POST_V1_PRODUCT_ROADMAP.md](plans/POST_V1_PRODUCT_ROADMAP.md); next initiative **Glossary MVP** (no implementation started; no F15) |
