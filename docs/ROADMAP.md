...
| **F12** Limited rollout | **Implementation complete** — [canonical plan](plans/STRATEGY_F_F12_LIMITED_ROLLOUT.md); [validation log](plans/F12_LIMITED_ROLLOUT_VALIDATION_LOG.md) in progress; **observation window pending** |
