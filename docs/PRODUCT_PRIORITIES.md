...
**Current next program:** Translation Intelligence & Quality (TIQ). **TQ.0–TI.6 Complete**. Exact next step: **finish TI.7 planning freeze** ([plan](plans/TI7_CONTROLLED_AUTO_PUBLICATION_POLICY_IMPLEMENTATION_PLAN.md); [ADR-0020](adr/0020-controlled-auto-publication-and-frontend-gate.md) Proposed). **TI.7** implementation not started. **TIQ not Complete.**
...
|---|---|---|
| 1 | **TIQ** / **TI.7** planning | [TI.7 plan](plans/TI7_CONTROLLED_AUTO_PUBLICATION_POLICY_IMPLEMENTATION_PLAN.md) architecture-review candidate; [ADR-0020](adr/0020-controlled-auto-publication-and-frontend-gate.md) Proposed; implementation not started |
...
| **TI.7 milestone plan** | [`plans/TI7_CONTROLLED_AUTO_PUBLICATION_POLICY_IMPLEMENTATION_PLAN.md`](plans/TI7_CONTROLLED_AUTO_PUBLICATION_POLICY_IMPLEMENTATION_PLAN.md) (architecture-review candidate until frozen) |
| **ADR-0020 (TI.7 publication)** | [`adr/0020-controlled-auto-publication-and-frontend-gate.md`](adr/0020-controlled-auto-publication-and-frontend-gate.md) |
