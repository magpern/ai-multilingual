...
**Current next decision:** **v1.6.0 release preparation IN PROGRESS** — [scope](releases/V1_6_0_RELEASE_SCOPE.md). Accumulated train P0 + P1 + P2. Version bump to **1.6.0**; TARGET **8**; migration **NONE**. **TAG / GITHUB RELEASE / DEPLOY NOT AUTHORIZED** in prep. **P0/P1/P2 COMPLETE**. Historical Program B **REDEFINED** into bounded P0. **MSEO PROGRAM COMPLETE — MSEO.0–MSEO.5**. Runtime `Migrator::TARGET` **8**.
