...
**A.7a** (Product & Catalog) is already complete. **A.7b** is complete on `main` (tag `a7b-woocommerce-archive-chrome-complete`); the next planning/implementation target is therefore **A.7c**.
