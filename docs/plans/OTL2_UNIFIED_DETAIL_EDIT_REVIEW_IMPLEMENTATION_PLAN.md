...
**Next:** OTL.4 Jobs Integration — **planning only** from closed OTL.3 ([OTL3_PUBLICATION_STALE_WORKFLOW_VALIDATION_LOG.md](OTL3_PUBLICATION_STALE_WORKFLOW_VALIDATION_LOG.md)). Do **not** start OTL.4–OTL.6 implementation or TSC under OTL until planned/frozen.
