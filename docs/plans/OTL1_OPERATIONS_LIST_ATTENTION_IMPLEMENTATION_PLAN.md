...
**Next:** OTL.2 Unified Detail + Edit/Review — [OTL2_UNIFIED_DETAIL_EDIT_REVIEW_IMPLEMENTATION_PLAN.md](OTL2_UNIFIED_DETAIL_EDIT_REVIEW_IMPLEMENTATION_PLAN.md) (**Architecture Frozen** after planning review PASS/merge; **implementation next**). Do **not** start TSC under OTL.
