...
- **A.SEO** ([parent plan](ASEO_PARENT_IMPLEMENTATION_PLAN.md) Architecture Frozen (planning); waves A.SEOa–A.SEOf) — **A.SEOa–A.SEOe Complete**; **A.SEOf** [plan](ASEOF_SEO_DIAGNOSTICS_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; Supported SF1–SF14; Partially Supported SF15; [evidence](aseof-evidence/); implementation not started); next: A.SEOf implementation after plan merge
...
- **A.SEO** — Late, low coupling to editor identity work — [parent plan](ASEO_PARENT_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; freeze merged to `main`; waves **A.SEOa–A.SEOf**); [dependency matrix](A_SEO_DEPENDENCY_MATRIX.md); **A.SEOa–A.SEOe Complete**; **A.SEOf** [plan](ASEOF_SEO_DIAGNOSTICS_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; [evidence](aseof-evidence/); implementation not started)
...
| A.SEOf | SEO diagnostics, validation, health, verification | Operational — [plan](ASEOF_SEO_DIAGNOSTICS_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; Supported SF1–SF14; Partially Supported SF15; [evidence](aseof-evidence/); implementation not started) |
