...
- **A.SEO** ([parent plan](ASEO_PARENT_IMPLEMENTATION_PLAN.md) Architecture Frozen (planning); waves A.SEOa–A.SEOf) — **A.SEOa–A.SEOd Complete**; **A.SEOe** [plan](ASEOE_SITEMAPS_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; Supported SE1–SE9/SE12; Deferred SE10/SE11; [evidence](aseoe-evidence/); implementation not started); next: A.SEOe implementation after plan merge; A.SEOf remains later
...
- **A.SEO** — Late, low coupling to editor identity work — [parent plan](ASEO_PARENT_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; freeze merged to `main`; waves **A.SEOa–A.SEOf**); [dependency matrix](A_SEO_DEPENDENCY_MATRIX.md); **A.SEOa–A.SEOd Complete**; **A.SEOe** [plan](ASEOE_SITEMAPS_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; [evidence](aseoe-evidence/); implementation not started); A.SEOf not started
...
| A.SEOe | XML sitemaps, robots, indexability, discovery | Product — [plan](ASEOE_SITEMAPS_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; Supported SE1–SE9/SE12; Deferred SE10/SE11; [evidence](aseoe-evidence/); implementation not started) |
