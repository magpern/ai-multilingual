...
- **A.7** WooCommerce visitor-facing coverage family — [plan](A7_WOOCOMMERCE_VISITOR_COVERAGE_IMPLEMENTATION_PLAN.md); **A.7a** Product & Catalog — **Complete** (`a7a-woocommerce-product-catalog-complete`); **A.7b** Archive Chrome — [plan](A7B_WOOCOMMERCE_ARCHIVE_CHROME_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; implementation not started); A.7c/A.7d unchanged
...
| A.7 | WooCommerce visitor-facing coverage family (see §6.2) | Product — [family plan](A7_WOOCOMMERCE_VISITOR_COVERAGE_IMPLEMENTATION_PLAN.md); **A.7a Complete**; **A.7b** [plan](A7B_WOOCOMMERCE_ARCHIVE_CHROME_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; implementation not started) |
...
| A.7b | Archives listing chrome (Woo-owned orderby labels) | Product — [plan](A7B_WOOCOMMERCE_ARCHIVE_CHROME_IMPLEMENTATION_PLAN.md) (**Architecture Frozen (planning)**; implementation not started) |
