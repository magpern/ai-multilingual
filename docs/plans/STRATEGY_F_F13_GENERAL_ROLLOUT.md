...
**Status:** FROZEN — canonical implementation specification (GA-only refinement).  
...
**Depends on:** F1–F12 complete and merged; F12 §20 entry gate PASS; observation window closed with operator sign-off.  
**ADR-0013:** Disposition required before F13.2+ (Accepted, or explicit documented proceed-despite-Proposed).  
...
**Validation log (reserved):** [F13_GENERAL_AVAILABILITY_VALIDATION_LOG.md](F13_GENERAL_AVAILABILITY_VALIDATION_LOG.md) — created during F13 execution; not part of this plan.  
