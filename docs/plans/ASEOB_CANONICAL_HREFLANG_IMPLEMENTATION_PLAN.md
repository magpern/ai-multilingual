...
**Status:** **Complete** — merged to `main`; tag `a-seob-canonical-hreflang-complete`
...
Supported set {SB1–SB11} is merged and tagged. Downstream SEO waves must consume SB11 unchanged. A.SEOc has not been started.
