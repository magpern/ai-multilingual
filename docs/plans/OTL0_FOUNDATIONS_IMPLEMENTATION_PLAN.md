...
**Next:** OTL.1 Operations list + attention — [OTL1_OPERATIONS_LIST_ATTENTION_IMPLEMENTATION_PLAN.md](OTL1_OPERATIONS_LIST_ATTENTION_IMPLEMENTATION_PLAN.md) (plan freeze). Do **not** implement OTL.1 until that plan is independently reviewed and frozen on `main`. Do **not** start TSC under OTL.
