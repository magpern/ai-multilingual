...
**Production implementation status:** **OTL.0 Complete** on `main` (merge `13e68f9d51ca5a4a0a8704ed048cf51e3eec3d3a`). **OTL.1 Complete** on `main` (merge `466eb6a470b2ea48b949bc05e0717afbc6600fc3`). **OTL.2 Complete** on `main` (merge `060649d9a8cf20c3698f9ed145d29c8d20d67143`). **OTL.3 Complete** on `main` (merge `77fc39da5d9b30d204e5a0c04e318a463ad39484`). OTL.4–OTL.6 implementation and TSC remain not started.

**Next:** Begin the definitive **OTL.4 Jobs Integration planning** process from the closed OTL.3 main baseline. Do not implement OTL.4 until its plan has been externally reviewed, materialized, independently reviewed, and frozen on main. Do not start OTL.5–OTL.6 or Translation Surface Coverage (TSC) under OTL.
...
Exact next step: begin the definitive **OTL.4 Jobs Integration planning** process from the closed OTL.3 main baseline ([OTL3_PUBLICATION_STALE_WORKFLOW_VALIDATION_LOG.md](OTL3_PUBLICATION_STALE_WORKFLOW_VALIDATION_LOG.md)). Do not implement OTL.4 until its plan has been externally reviewed, materialized, independently reviewed, and frozen on main. Do not start OTL.5–OTL.6 or TSC planning/implementation under OTL.
