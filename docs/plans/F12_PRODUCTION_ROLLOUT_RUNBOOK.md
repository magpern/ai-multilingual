...
**F12 status:** **Complete** — merged to `main`. Observation window 2026-08-05 → 2026-08-12 on dev.biopentra.eu. F13 GA implemented on `feature/f13-general-availability` (not merged).
