<?php
/**
 * Core image caption adapter (A.0).
 *
...
/**
 * Block-local figcaption only — never Media Library attachment metadata.
 */
final class ImageAdapter extends AbstractBlockAdapter {
	...
	private function caption_source( array $block ): string {
		...
		return InnerHtmlReplacer::first_tag_inner_html( $html, 'figcaption' );
	}
}
