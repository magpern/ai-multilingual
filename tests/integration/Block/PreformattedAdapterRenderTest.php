<?php
/**
 * F14 preformatted frontend render-safety integration.
 *
...
/**
 * Render-safety for core/preformatted.
 */
final class PreformattedAdapterRenderTest extends AimlTestCase {

	private const UUID = '550e8400-e29b-41d4-a716-4466554400d2';

	public function test_preformatted_renders_translation_without_false_positive(): void {
		$swedish = $this->add_language();
		$content = '<!-- wp:preformatted {"aimlBlockId":"' . self::UUID . '"} --><pre class="wp-block-preformatted">Alpha</pre><!-- /wp:preformatted -->';
		...
		$this->store->save_translation(
			array(
				...
				'source_text'     => '<pre class="wp-block-preformatted">Alpha</pre>',
		...
		$wrong = $frontend->render(
			$post,
			'<!-- wp:preformatted {"aimlBlockId":"550e8400-e29b-41d4-a716-4466554400ff"} --><pre class="wp-block-preformatted">Other</pre><!-- /wp:preformatted -->'
		);
